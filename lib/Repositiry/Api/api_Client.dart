...
class ApiClient {
  Future<Response> invokeAPI(String path, String method, Object? body) async {
    ...
    String authorisation= prefs.getString("authorisation").toString();
    ...
    switch (method) {
      ...
      case "PUT":
        ...
        break;
      case "DELETE":
        response = await delete(Uri.parse(url), headers: {"token":'Bearer $authorisation'}, body: body);
        break;
      case "POST_":
        response = await post(
          Uri.parse(url),
